		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoices List",
									"targetURL": "#learningfioriinvoices-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"learningfioriinvoices-display": {
								"semanticObject": "learningfioriinvoices",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=learningfiori.invoices",
									"url": sap.ui.require.toUrl("learningfiori/invoices")
								}
							}
						}
					}
